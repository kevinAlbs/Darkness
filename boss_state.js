var state_boss = (function(){
  ...
  that.preload = function(){
    ...
    game.load.image("black_particle", "black_particle.png");
    ...
    game.load.image("boss_body", "boss_body.png");
    game.load.image("boss_head", "boss_head.png");
    game.load.image("boss_tail", "boss_tail.png");
  ...
  that.create = function(){
    ...
    if(first_death_occured){
      ...
      //show intro text
      TextOverlay.say(CONFIG.CONVOS["boss_fight"]);
    }
